...
public class EstudoLinkedHashSet {
    public static void main(String[] args) {
        /* Informações sobre LINKEDHASHSET
           É a implementação intermediaria em termos de performance para a interface SET;
           É uma versão ordenada do HashSet.
           LINKEDHASHSET garante a ordem de inserção dos elementos;

         */

        // Instanciando uma estrutura de coleção LINKEDHASHSET para Strings e nomeando-a por set.
        ...
        numbers3.add(5);
        numbers3.add(7);
        Set<Integer> numbers4 = new LinkedHashSet<>();
        numbers4.add(1);
        numbers4.add(3);
        numbers4.add(5);
        numbers4.add(7);
