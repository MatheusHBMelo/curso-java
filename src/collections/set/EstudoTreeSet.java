...
public class EstudoTreeSet {
    public static void main(String[] args) {
        ...
        /* Informações sobre TREESET
           É a implementação mais lenta para a interface SET;
           TREESET garante a ordem dos elementos de acordo com parametros, {string = alfabeto, number = ordem};
           Trabalha bem com tipos primitivo, por tanto, deve-se implementar comparator para trabalhar com classes

           Se a ordem importa e a performance não, o TREESET é indicado.
         */

        // Instanciando uma estrutura de coleção TREESET para Strings e nomeando-a por set.
